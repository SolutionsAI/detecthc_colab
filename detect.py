...
@torch.no_grad()
def detectCOM(weights='yolov5s.pt',  # model.pt path(s)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if c == 2:
                        ...
                        c = 4
                        ComConf = ''
                    else: #REEMPLAZAR el RANDOM por la funcion de COM
                        ...
                        #COM = llamar()
                        COM , ComConf  = detectCOM('/content/detecthc_weights/SoloCOM94b.pt','/content/recorte.jpg')
